...
<html>
    <head>
        ...
        <style>
            ...
            .border-bottom-l {  border-color: #bbdbcc;  }
            .border-bottom-n {  border-color: #6ab69a;  }
            .border-bottom-d {  border-color: #00895f;  }
            .border-top-l {  border-color: #bbdbcc;  }
            .border-top-n {  border-color: #6ab69a;  }
            .border-top-d {  border-color: #00895f;  }
